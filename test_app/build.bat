...
pushd .\bin
cl %Common% %RendererIncludePath% %ThirdPartyIncludePath% %VulkanIncludePath% -DUNIT_TESTS ..\..\source\ak_renderer.cpp -link user32.lib Advapi32.lib -out:Tests.exe

cl %Common% %RendererIncludePath% %ThirdPartyIncludePath% %VulkanIncludePath% -LD ..\..\source\ak_renderer.cpp -link user32.lib Advapi32.lib -out:ak_renderer.dll
